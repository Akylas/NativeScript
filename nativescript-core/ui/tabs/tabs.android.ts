...
export class Tabs extends TabsBase {
    ...
    public createNativeView() {
        ...
        const tabsBar = new org.nativescript.widgets.TabsBar(context);
        ...
        const adapterInterface = new org.nativescript.widgets.PagerAdapter.Interface({
            getCount: this.getCount.bind(this),
            getPageTitle: this.getPageTitle.bind(this),
            startUpdate: this.startUpdate.bind(this),
            instantiateItem: this.instantiateItem.bind(this),
            getItemPosition: this.getItemPosition.bind(this),
            destroyItem: this.destroyItem.bind(this),
            setPrimaryItem: this.setPrimaryItem.bind(this), 
            finishUpdate: this.finishUpdate.bind(this),
            isViewFromObject: this.isViewFromObject.bind(this),
            saveState: this.saveState.bind(this),
            restoreState: this.restoreState.bind(this)
        });
        const adapter = new org.nativescript.widgets.PagerAdapter(adapterInterface);
    ...
    public initNativeView(): void {
        ...
        const listener = new org.nativescript.widgets.TabsBar.Listener({
            onSelectedPositionChange:this.onSelectedPositionChange.bind(this),
            onTap:this.onTabsBarTap.bind(this),
        });
        this._tabsBar.setListener(listener)
        (this._tabsBar as any).listener = listener;
    ...
    protected onSelectedPositionChange(position: number, prevPosition: number): void {
    ...
    protected onTabsBarTap(position: number): boolean {
    ...
    protected getPageTitle(index: number) {
        const items = this.items;
    ...
    protected startUpdate(container: android.view.ViewGroup): void {
        if (container.getId() === android.view.View.NO_ID) {
            throw new Error(`ViewPager with adapter ${this} requires a view containerId`);
        }
    }

    protected instantiateItem(container: android.view.ViewGroup, position: number): java.lang.Object {
    ...
    protected getItemPosition(object: java.lang.Object): number {
        return this.items ? POSITION_UNCHANGED : POSITION_NONE;
    }

    protected destroyItem(container: android.view.ViewGroup, position: number, object: java.lang.Object): void {
        if (!this.mCurTransaction) {
            const fragmentManager = this._getFragmentManager();
            this.mCurTransaction = fragmentManager.beginTransaction();
        }
    ...
    protected setPrimaryItem(container: android.view.ViewGroup, position: number, object: java.lang.Object): void {
    ...
    protected finishUpdate(container: android.view.ViewGroup): void {
        this._commitCurrentTransaction();
    }

    protected isViewFromObject(view: android.view.View, object: java.lang.Object): boolean {
        return (<androidx.fragment.app.Fragment>object).getView() === view;
    }

    protected saveState(): android.os.Parcelable {
    ...
    protected restoreState(state: android.os.Parcelable, loader: java.lang.ClassLoader): void {
        //
    }

    protected getItemId(position: number): number {
        return position;
    }
    ...
    loadBitmapFromView(view: android.view.View): android.graphics.Bitmap {
    ...
    public disposeNativeView() {
        ...
        (this._tabsBar as any).listener = null;
        this._tabsBar = null;
